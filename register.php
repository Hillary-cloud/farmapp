        ...
        <div class="container">
            ...
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                    ...
                    <span class="icon-bar"></span>
                    <span class="icon-bar"></span>
                </button> <a class="navbar-brand" href="index.php" style = "padding-right = 45px; "><strong>Farm Link</strong></a>
            </div>
...
//
	if(isset($_POST['signUpbtn']) ){
				...
				if($_POST['password'] == $_POST['confirmpassword']){
					   ...
					   $email = $_POST['email'];
						...
						//$hashed_password = password_hash($password, PASSWORD_DEFAULT);
							...
							$sql = "INSERT INTO farmers(CompanyName, Email, FarmLocation, Password)
							VALUES ('$username', '$email', '$FarmLocation', '$password')";
						...
						";
                            $resultq = $conn->query($sql)or die("Last error: {$conn->error}\n");
                            if ($resultq) {
								?>
			...
			<p style='padding-left:5px; margin-bottom: 0px;color: #808080;'>Please select category</p>
			 ...
			 <div class="form-group" style = "position:relative;">
			   <input type="text"  style = "padding-left: 25px;" class="form-control" placeholder="Farm location, strictly for farmers only. " id="FarmLocation" name ="FarmLocation">
			   <i class="" style = "position: absolute; left: 0; top:2px; padding: 9px 8px; color: #aaa"></i>
			 </div>
